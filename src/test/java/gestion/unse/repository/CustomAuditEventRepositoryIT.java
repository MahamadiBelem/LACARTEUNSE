package gestion.unse.repository;

import gestion.unse.PersonnelUnseApp;

import gestion.unse.config.Constants;
import gestion.unse.config.audit.AuditEventConverter;
import gestion.unse.domain.PersistentAuditEvent;
...
import static gestion.unse.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
